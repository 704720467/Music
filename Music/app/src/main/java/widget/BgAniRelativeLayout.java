 ...
 */
public class BgAniRelativeLayout extends RelativeLayout {
    ...
    public BgAniRelativeLayout(Context context) {
        this(context, null);
    }

    public BgAniRelativeLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BgAniRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initLayerDrawable() {
        Drawable backgroundDrawable = getContext().getResources().getDrawable(R.drawable.ic_blackground);
    ...
    private void initObjectAnimator() {
        ...
        objectAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                BgAniRelativeLayout.this.setBackground(layerDrawable);
            }
        });
