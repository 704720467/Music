...
import com.example.administrator.myapplication.MusicplayerActivity2;
...
public class MyMusicService extends Service implements MediaPlayer.OnCompletionListener {
    ...
    private void play(final int index) {
        ...
        if (mCurrentMusicIndex == index && mIsMusicPause) {
            ...
            mMediaPlayer = MediaPlayer.create(getApplicationContext(), mMusicDatas.get(index).getMusicRes());
            mMediaPlayer.start();
